...
fields = {
    "byr": lambda f: bool(re.match(r"^\d{4}$", f)) and num_range(f, 1920, 2002),
    "iyr": lambda f: bool(re.match(r"^\d{4}$", f)) and num_range(f, 2010, 2020),
    "eyr": lambda f: bool(re.match(r"^\d{4}$", f)) and num_range(f, 2020, 2030),
    "hgt": lambda f: (bool(re.match(r"^\d+cm$", f)) and num_range(f, 150, 193))
    or (bool(re.match(r"\d+in$", f) and num_range(f, 59, 76))),
